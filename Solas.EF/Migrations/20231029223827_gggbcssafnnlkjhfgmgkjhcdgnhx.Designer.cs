...
namespace Solas.EF.Migrations
{
    ...
    [Migration("20231029223827_gggbcssafnnlkjhfgmgkjhcdgnhx")]
    partial class gggbcssafnnlkjhfgmgkjhcdgnhx
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("OptionOrderProduct", b =>
                {
                    ...
                    b.HasKey("OptionsOptionId", "orderProductsOrderProductId");

                    b.HasIndex("orderProductsOrderProductId");

                    b.ToTable("OrderProductOptions", (string)null);
                });
            ...
            modelBuilder.Entity("Solas.BL.Models.CouponCode", b =>
                {
                    b.Property<int>("CouponCodeId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("CouponCodeId"));
            ...
            modelBuilder.Entity("Solas.BL.Models.Menu", b =>
                {
            ...
            modelBuilder.Entity("Solas.BL.Models.StoreInfo", b =>
                {
                    ...
                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("StoreInfoId"));

                    b.Property<string>("LogoPath")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("SupportCenterAvailable")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");

                    b.Property<int>("SupportCenterNumber")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Solas.BL.Models.SubMenu", b =>
                {
            ...
            modelBuilder.Entity("OptionOrderProduct", b =>
                {
                    b.HasOne("Solas.BL.Models.Option", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Solas.BL.Models.Order", b =>
                {
                    b.HasOne("Solas.BL.Models.Address", "Address")
                        .WithMany("orders")
            ...
            modelBuilder.Entity("Solas.BL.Models.SocialMedia", b =>
                {
                    b.HasOne("Solas.BL.Models.StoreInfo", "StoreInfo")
            ...
            modelBuilder.Entity("Solas.BL.Models.SubMenu", b =>
                {
                    b.HasOne("Solas.BL.Models.Menu", "Menu")
                        .WithMany("subMenus")
